    ...
    <div class="row">
        <div class="table-responsive table-bordered col-sm-5 ml-auto mr-auto mt-2">
            <div class="page-header">
                ...
                <a class="text-danger" href="<?= base_url('member/data_user'); ?>"><i class="fas fa-search mt-2 float-right">Tampilkan</i></a>
            </div>
        ...
        <div class="table-responsive table-bordered col-sm-5 ml-auto mr-auto mt-2">
            <div class="page-header">
                ...
                <a href="<?= base_url('user/data_buku'); ?>"><i class="fas fa-search text-primary mt-2 float-right">Tampilkan</i></a>
            </div>
